...
export default function InvoicePDF({ order, lines, customer, appSettings }: InvoicePDFProps) {
  ...
  const css = `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .kpi-seg { flex: 1; padding: 10px 16px; border-right: 1px solid #E6E0D5; height: 72px; display: flex; flex-direction: column; justify-content: center; gap: 6px; }
    .kpi-seg-accent { flex: 1.2; padding: 10px 16px; background: ${accent}; height: 72px; display: flex; flex-direction: column; justify-content: center; gap: 6px; }
