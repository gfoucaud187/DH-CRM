...
import { Plus, Search, MapPin, Phone, Mail, Camera, Trash2, X, ChevronDown, ChevronUp, Edit, Save, ArrowLeft, Users, Store, User } from 'lucide-react'
...
export default function RetailersPage() {
  ...
  const [tab, setTab] = useState<'shops' | 'b2c'>('shops')
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={tab === 'shops' ? openNewShop : openNewB2c}
